...
- `references/template-source/`: 템플릿 예시 HTML과 참고 이미지
...
- HTML 작성 전 `references/template-source/README.md`, `examples/template.html`, `examples/sample.html`, `images/`를 확인합니다.
